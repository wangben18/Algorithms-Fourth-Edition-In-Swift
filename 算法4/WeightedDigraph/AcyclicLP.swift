...
//  算法4
//
//  Created by liushan on 2019/6/15.
...
class AcyclicLP {
    ...
    init(_ G: EdgeWeightedDigraph, _ s: Int) {
        ...
        distTo = [Double](repeating: Double.negativeInfinity, count: G.V)
        distTo[s] = 0
...
extension Double {
    static var negativeInfinity: Double {
        var negativeInfinity = Double.infinity
        negativeInfinity.negate()
